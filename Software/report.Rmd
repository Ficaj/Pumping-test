...
```{r , echo=FALSE, comment = NA, warning = FALSE, memory.limit(size = 60000), fig.width = 9, fig.height = 4}
...
title <- textGrob("Table 1. well parameters",gp=gpar(fontsize = 18))
title2 <- textGrob("Table 2. aquifer parameters",gp=gpar(fontsize = 18))

tt3 <- ttheme_minimal(base_size = 14,
...
```{r , collapse=TRUE, echo=FALSE,comment = NA, fig.width = 11, fig.asp = 0.5, fig.align ='left', warning = FALSE }
